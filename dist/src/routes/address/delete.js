...
exports.AddressDeleteRouter = void 0;
const express_1 = __importDefault(require("express"));
const not_found_error_1 = require("../../exceptions/not-found-error");
const require_auth_1 = require("../../middlewares/require-auth");
const address_1 = require("../../models/address");
const Router = express_1.default.Router();
exports.AddressDeleteRouter = Router;
Router.delete('/api/address/:id', require_auth_1.requireAuth, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
