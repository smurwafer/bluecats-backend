...
exports.GambleUpdateRouter = void 0;
const express_1 = __importDefault(require("express"));
const require_auth_1 = require("../../middlewares/require-auth");
const gamble_1 = require("../../models/gamble");
const Router = express_1.default.Router();
exports.GambleUpdateRouter = Router;
Router.put('/api/gamble', require_auth_1.requireAuth, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
